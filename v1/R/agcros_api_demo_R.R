...
if(resp$status_code !=200){ # checks the status code of the get response. 200 is a successful response.
...
if(gfluxUrl$status_code !=200){ # checks the status code of the get response. 200 is a successful response.
  print("Error: failed to retrieve exp units") # error message returned if the GET query is unsuccessful - could be an issue with URL, etc.
}
